...
function desisteJogo() {
    let popup = document.getElementById('img').src = 'img/ss.jpg';
...
function mudaImagem() {
    let imagem = ["img/forca01.png", "img/forca02.png", "img/forca03.png", "img/forca04.png", "img/forca05.png", "img/forca06.png"];
    switch(tentativas) {
